...
const Home: FunctionComponent = (): JSX.Element => {
  ...
  const theme = useResponsiveValue(['100px', '200px', '300px', '400px']);
  ...
  if (isBreakpoint) {
    return (
      <Flex sx={{ flexDirection: 'column' }}>
        ...
        <Heading as="h1" sx={{ color: 'muted', alignSelf: 'center', marginBottom: 2 }}>Software Engineer.</Heading>
          <Heading as="h1" sx={{ color: 'muted', alignSelf: 'center', marginBottom: 2 }}>Veteran.</Heading>
          <Heading as="h1" sx={{ color: 'muted', alignSelf: 'center', marginBottom: 2 }}>Husband.</Heading>
          <Heading as="h1" sx={{ color: 'muted', alignSelf: 'center', marginBottom: 2 }}>Father.</Heading>
          <Text sx={{ color: 'muted' }}>
